<x-admin-layout>
    <x-slot name="title">Tambah Beasiswa Baru</x-slot>
    <x-slot name="header">Tambah Beasiswa Baru</x-slot>
    ...
    <div class="bg-white border border-slate-200 rounded-3xl p-6 sm:p-8 shadow-sm max-w-3xl">
        <form action="{{ route('admin.beasiswa.store') }}" method="POST" class="space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-1">
                    ...
                    <x-text-input id="judul" name="judul" type="text" required class="w-full mt-1 block" placeholder="Contoh: Beasiswa LPDP 2026" :value="old('judul')" />
                ...
                <div class="space-y-1">
                    ...
                    <x-text-input id="penyelenggara" name="penyelenggara" type="text" required class="w-full mt-1 block" placeholder="Contoh: Kementerian Keuangan RI" :value="old('penyelenggara')" />
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-1">
                    ...
                    <select name="kategori" id="kategori" required class="w-full border-slate-200 focus:border-[#1E3A5F] focus:ring-[#1E3A5F] rounded-xl shadow-sm bg-slate-50 text-slate-800 text-sm py-2.5 px-4 mt-1">
                        <option value="dalam negeri" {{ old('kategori') == 'dalam negeri' ? 'selected' : '' }}>Dalam Negeri</option>
                        <option value="luar negeri" {{ old('kategori') == 'luar negeri' ? 'selected' : '' }}>Luar Negeri</option>
                    </select>
                ...
                <div class="space-y-1">
                    ...
                    <x-text-input id="jenjang" name="jenjang" type="text" required class="w-full mt-1 block" placeholder="Contoh: S1 / S2 / S3 / D3" :value="old('jenjang')" />
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-1">
                    ...
                    <x-text-input id="jurusan" name="jurusan" type="text" required class="w-full mt-1 block" placeholder="Contoh: Semua Jurusan / Teknik" :value="old('jurusan', 'Semua Jurusan')" />
                ...
                <div class="space-y-1">
                    ...
                    <x-text-input id="min_ipk" name="min_ipk" type="number" step="0.01" min="0.00" max="4.00" class="w-full mt-1 block" placeholder="Kosongkan jika tidak ada" :value="old('min_ipk')" />
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-1">
                    ...
                    <x-text-input id="deadline" name="deadline" type="date" required class="w-full mt-1 block" :value="old('deadline')" />
                ...
                <div class="space-y-1">
                    ...
                    <x-text-input id="link_resmi" name="link_resmi" type="url" class="w-full mt-1 block" placeholder="https://..." :value="old('link_resmi')" />
            ...
            <div class="space-y-1">
                ...
                <textarea id="deskripsi" name="deskripsi" rows="6" required class="w-full border-slate-200 focus:border-[#1E3A5F] focus:ring-[#1E3A5F] rounded-xl shadow-sm bg-slate-50 text-slate-800 text-sm py-2.5 px-4 mt-1" placeholder="Masukkan detail cakupan beasiswa, persyaratan dokumen, dll.">{{ old('deskripsi') }}</textarea>
