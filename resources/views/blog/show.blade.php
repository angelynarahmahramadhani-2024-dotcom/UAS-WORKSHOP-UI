...
<head>
    ...
    <title>{!! $post->title !!} — FindShip</title>
    <!-- Fonts -->
    ...
    <style>
        ...
        /* Custom typography styling for content */
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-sm">
                    ...
                    <div class="p-6 sm:p-8 space-y-6">
                        <div class="space-y-3">
                            <h1 class="text-2xl sm:text-3xl font-extrabold text-[#1E3A5F] leading-snug">{!! $post->title !!}</h1>
                            ...
                            <div class="flex items-center gap-4 text-xs text-slate-400 font-semibold border-b border-slate-100 pb-4">
                                <span class="flex items-center gap-1">
                                    ...
                                    Oleh: <strong class="text-slate-600">{{ $post->author ?? 'Penulis FindShip' }}</strong>
                                </span>
                                <span class="flex items-center gap-1">
                                    ...
                                    {{ $post->created_at ? $post->created_at->format('d M Y, H:i') : '' }} WIB
                                </span>
                            </div>
                        </div>
