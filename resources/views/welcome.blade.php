                    ...
                    <div>
                        ...
                        <div class="relative h-48 bg-slate-200">
                            @if(isset($article['_embedded']['wp:featuredmedia'][0]['source_url']))
                                <img src="{{ $article['_embedded']['wp:featuredmedia'][0]['source_url'] }}" alt="{{ $article['title']['rendered'] }}" class="w-full h-full object-cover" onerror="this.onerror=null; this.src='https://images.unsplash.com/photo-1523050854058-8df90110c9f1?q=80&w=600&auto=format&fit=crop';">
                            @else
